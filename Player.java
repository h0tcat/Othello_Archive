      ...
      if (turnID % 2 == 1) {
        while (true) {
          if (index >= 9) { // もし右端まで探索したらすぐに結果を返す
            ...
            index++;
            if (Othello1.board[index] == 1) {
              return index;
            } else if (Othello1.board[index] == 0) {
              break;
            }
          }
        }
